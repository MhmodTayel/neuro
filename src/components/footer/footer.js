          ...
          <div class="container text-center text-md-start mt-5 pt-3">
            <div class="row mt-3">
              ...
              <div class="col-md-6 col-lg-4 col-xl-3 mx-auto mb-md-0 mb-4">
                ...
                <p> <FontAwesomeIcon className='icon'icon={faHome} />Giza, Cairo, Egypt</p>
                <p><FontAwesomeIcon className='icon' icon={faEnvelope} /> <span className='mail' >Neuroaitronix@gmail.com</span>
                </p>
                <p><FontAwesomeIcon className='icon' icon={faPhone} /> + 20 111 74 67 283 </p>
                 <p><FontAwesomeIcon className='icon' icon={faPhone} /> + 20 106 61 49 088</p>
